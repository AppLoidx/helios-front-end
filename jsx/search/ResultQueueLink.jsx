...
class ResultQueueLink extends React.Component {
    constructor(props) {
        super(props);
        this.state = {sendingReq: false, showModal: false};
        ...
        return (
            <div className="media text-muted pt-3">
                ...
                <div className="media-body pb-3 mb-0 small lh-125" data-aos='flip-up'>
                    ...
                    <span
                        className="d-inline-block text-secondary">Количество участников: {this.props.membersCount}</span>
                    <span className="d-block text-secondary">Дата создания: {this.props.creationDate}</span>
                </div>
            </div>
        )
    }
