                            ...
                            <div className="col-6 justify-content-center">
                                <div className="form-group row">
                                    <div className="col-md-6">
                                        <input type="text" className="form-control was-validated" placeholder="Имя"
                                               value={this.state.name} onChange={this.nameInpChange}/>
                                    </div>
                                    <div className="col-md-6">
                                        <input type="text" className="form-control was-validated" placeholder="Фамилия"
                                               value={this.state.lastname} onChange={this.lastnameInpChange}/>
                                    </div>


                                </div>
                                <div className="form-group">
                                    <input type="email" className="form-control was-validated"
                                           placeholder="Электронная почта" value={this.state.email}
                                           onChange={this.emailInpChange}/>
                                </div>
                                <div className="form-group">
                                    <input type="password" className={"form-control " + this.state.passwordClass}
                                           placeholder="Your Password" value={this.state.password}
                                           onChange={this.passInpChange}/>
                                </div>
                                <div className="form-group">
                                    <input type="password" className={"form-control " + this.state.passConfirmClass}
                                           placeholder="Confirm Password" value={this.state.passConfirm}
                                           onChange={this.confPassInpChange}/>
                                </div>
                                <div className="form-group mx-auto">
                                    <button type="button" onClick={this.register}
                                            className="btn-primary btn justify-content-center mx-auto">Регистрация
                                    </button>
                                </div>
